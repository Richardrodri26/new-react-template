...
import { TypeParameterEnum, useCreateParameterMutation, useCreateTipoProyectoMutation } from "@/domain/graphql";
...
export const CreateParameter = () => {
  const [createMutation] = useCreateTipoProyectoMutation();
  ...
  const onSubmit = async (data: CreateParameterSchemaType) => {
    try {
      toast.info("Creando tipo de proyecto...");
      ...
      toast.success("Tipo de proyecto creado con éxito");
